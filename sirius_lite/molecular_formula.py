...
import re
# from . import mass
import sirius_lite.mass as mass
import itertools
import math
...
def neutral_mass_to_formula(lo_mass: float, hi_mass: float):
...
def precursor_mass_to_formula(lo_mass: float, hi_mass: float, adduct: str):
    lo_mass -= mass.single_charged_adduct_mass[adduct]
    hi_mass -= mass.single_charged_adduct_mass[adduct]
